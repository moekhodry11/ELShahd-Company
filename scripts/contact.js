...
document.addEventListener('click', function(e) {
    ...
    if (e.target.closest('.phone-action')) {
        e.preventDefault();
        const phoneNumber = e.target.closest('.phone-action').getAttribute('href').replace('tel:', '');
    ...
    if (e.target.closest('.email-action')) {
        e.preventDefault();
        const email = e.target.closest('.email-action').getAttribute('href').replace('mailto:', '');
    ...
    if (e.target.closest('.whatsapp-action')) {
        ...
        const message = 'Hello! I am interested in your agricultural products and would like to discuss business opportunities.';
