...
const productData = {
    straw: {
        title: "Premium Straw",
        description: "High-quality wheat and rice straw, carefully harvested and processed to ensure optimal nutritional value and cleanliness. Perfect for livestock bedding and feed supplement.",
        specifications: {
        ...
        storage: "Store in dry, well-ventilated areas. Protect from moisture and direct sunlight. Recommended storage temperature: 15-25°C.",
        shelfLife: "12-18 months when stored properly",
        images: ["../images/animal feed/item 1.jpg", "../images/animal feed/item 8.jpg"]
    },
    alfalfa: {
        title: "Dried Alfalfa",
        description: "Nutrient-rich dried alfalfa, sun-dried to preserve maximum nutritional value. Excellent source of protein, fiber, and essential minerals for livestock health and productivity.",
        specifications: {
        ...
        storage: "Store in cool, dry conditions. Avoid direct sunlight and moisture. Ideal storage temperature: 10-20°C with good ventilation.",
        shelfLife: "12-18 months when properly stored",
        images: ["../images/animal feed/item 2.jpg", "../images/animal feed/item 7.JPG"]
    },
    hay: {
        title: "Premium Hay",
        description: "Top-grade hay with optimal nutritional balance for dairy and beef cattle. Harvested at the perfect growth stage to ensure maximum palatability and digestibility.",
        specifications: {
            "Moisture Content": "12-15%",
            "Crude Protein": "8-12%",
            "Crude Fiber": "28-32%",
        ...
        storage: "Store in dry, well-ventilated barns or sheds. Keep off ground and protect from rain. Maintain proper air circulation.",
        shelfLife: "18-24 months under proper storage conditions",
        images: ["../images/animal feed/item 3.jpg", "../images/animal feed/item 6.jpg"]
    },
    chaff: {
        title: "Quality Chaff",
        description: "Finely processed chaff suitable for various livestock feeding requirements. Consistent particle size and optimal moisture content for easy mixing and feeding.",
        specifications: {
        ...
        storage: "Store in dry conditions with good ventilation. Protect from moisture and pests. Ideal humidity: below 65%.",
        shelfLife: "12-15 months when stored properly",
        images: ["../images/animal feed/item 4.jpg", "../images/animal feed/item 5.jpg"]
    },
    citrus: {
        title: "Premium Citrus",
        description: "Fresh oranges, lemons, and other citrus fruits from carefully selected Egyptian orchards. Harvested at peak ripeness and handled with care to maintain freshness.",
        specifications: {
        ...
        storage: "Cold storage at 2-8°C with 85-90% relative humidity. Maintain proper ventilation and avoid temperature fluctuations.",
        shelfLife: "3-4 weeks under proper cold storage conditions",
        images: ["../images/fruits/item 1.jpg", "../images/fruits/item 2.jpg"]
    },
    seasonal: {
        title: "Seasonal Fruits",
        description: "A variety of seasonal fruits including grapes, pomegranates, dates, and other premium varieties. Each fruit is carefully selected for export quality standards.",
        specifications: {
        ...
        storage: "Temperature and humidity controlled storage specific to each fruit type. Generally 0-5°C with appropriate humidity levels.",
...
function initializeProductNavigation() {
    ...
    navItems.forEach(item => {
        item.addEventListener('click', function(e) {
            ...
            const targetSection = category === 'all' ? 
        ...
        <div class="modal-product-info">
            ...
            <div class="modal-product-details">
                ...
                <div class="modal-section">
                    ...
                    <ul class="modal-list">
                        ${product.packaging.map(item => `<li>${item}</li>`).join('')}
                    </ul>
                </div>
...
function updateProductNavigation() {
    ...
    sections.forEach(section => {
        ...
        if (scrollPos >= sectionTop && scrollPos < sectionTop + sectionHeight) {
            ...
            const correspondingNav = document.querySelector(`[data-category="${sectionId}"]`);
            if (correspondingNav) {
